...
public class ConstantValues {
    ...
    //*********** API Base URL ********//
    public static final String WOOCOMMERCE_URL =  "http://192.168.189.1/";
    
    public static final String WOOCOMMERCE_CONSUMER_KEY = "YOUR_WOOCOMMERCE_KEY";
    public static final String WOOCOMMERCE_CONSUMER_SECRET = "YOUR_WOOCOMMERCE_SECRET";
